...
public class VUDEI : MonoBehaviour
{
    ...
    private IEnumerator Move1()
    {
        ...
        {
            // 移動
            transform.position = (Vector3)Vector2.MoveTowards(transform.position, obj1.transform.position, 0.03f);
            yield return null;
        }
    }
    ...
    private IEnumerator Move2()
    {
        ...
        {
            // 移動
            transform.position = (Vector3)Vector2.MoveTowards(transform.position, obj2.transform.position, 0.02f);
            yield return null;
        }
    }
